  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {/* Quick Assessment */}
        <Card className="cursor-pointer border-2 border-slate-300 animate-slide-up animate-fade-in stagger-delay-1">
        ...
        {/* Detailed Assessment */}
        <Card className="cursor-pointer border-2 border-slate-300 animate-slide-up animate-fade-in stagger-delay-2">
          <CardHeader className="text-center pb-4">
            <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
