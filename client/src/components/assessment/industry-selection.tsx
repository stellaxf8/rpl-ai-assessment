  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-slate-900 mb-3">Select Your <span style={{ color: '#cd0000', fontFamily: 'Arial Black, Arial, sans-serif', fontWeight: 'bold' }}>Industry</span></h2>
