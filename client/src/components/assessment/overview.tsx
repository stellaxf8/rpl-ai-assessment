    ...
    <section>
      <div className="text-center mb-8 sm:mb-12 animate-fade-in">
        ...
        <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto animate-slide-up animate-fade-in px-4">
          Want to find out if your organization is ready for AI implementation?
        </p>
      </div>
      ...
      <div className="bg-transparent border-2 rounded-xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-12 shadow-lg animate-slide-up animate-fade-in border-gray-300">
        <h3 className="text-xl sm:text-2xl font-semibold text-slate-900 mb-4 sm:mb-6 text-center">Why <span style={{ color: 'black', fontFamily: 'Arial Black', fontWeight: 'bold' }}>AI Readiness</span> Assessment is <span style={{ color: 'black', fontFamily: 'Arial Black' }}>Crucial</span></h3>
