  ...
  return (
    <section>
      ...
      <div className="bg-transparent border-2 rounded-xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-12 shadow-lg animate-slide-up animate-fade-in border-gray-300">
        <h3 className="text-xl sm:text-2xl font-bold text-slate-600 mb-4 sm:mb-6 text-center" style={{ fontFamily: '"Arial Nova Light", "Arial", sans-serif', fontWeight: 'bold' }}>Why AI Readiness Assessment is Crucial</h3>
