    ...
    <section>
      ...
      <div className="text-center mb-8 sm:mb-12 animate-fade-in animate-slide-up">
        <Button 
          ...
          size="lg"
          className="text-2xl sm:text-3xl px-16 sm:px-24 py-8 sm:py-10 shadow-2xl hover-lift button-press w-full sm:w-auto bg-[#cd0000] hover:bg-[#b30000] font-bold transform hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(205,0,0,0.3)] hover:shadow-[0_0_30px_rgba(205,0,0,0.5)]"
        >
          Start Assessment
