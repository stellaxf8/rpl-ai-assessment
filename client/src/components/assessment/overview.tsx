...
export default function Overview({ onStartAssessment }: OverviewProps) {
  return (
    <section>
      ...
      <div className="grid grid-cols-2 grid-rows-3 gap-2 sm:gap-3 lg:gap-4 mb-8 sm:mb-12 max-w-md mx-auto">
            ...
            >
              <CardContent className="p-2 sm:p-3 lg:p-4">
                <div className="flex items-center text-center">
                  ...
                  <h3 className="text-xs sm:text-sm lg:text-base font-semibold text-slate-600 ml-2 sm:ml-2 lg:ml-3 flex-1 text-left">{dimension.title}</h3>
                </div>
              </CardContent>
            </Card>
          );
