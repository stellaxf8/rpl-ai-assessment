...
**For example:**** When you add a new customer management tool, does it automatically sync with your existing email and accounting software, or do you have to manually copy data between systems?",
    options: [
      {
        value: 1,
...
**For example:**** Do you get alerts when your website is slow or when your email server is down, or do you only find out when employees complain that something isn't working?",
    options: [
      {
        value: 1,
...
**For example:** Can multiple employees video conference simultaneously without issues, or does internet slow down when several people are working online at the same time?",
    options: [
      {
        value: 1,
...
**For example:** Are customer contact details up-to-date and complete, or do you often find missing phone numbers, duplicate records, and outdated addresses in your system?",
    options: [
      {
        value: 1,
...
**For example:** Can your marketing team quickly get sales data to create reports, or do they need to submit requests to IT and wait weeks to get the information they need?",
    options: [
      {
        value: 1,
...
**For example:** Do you have clear rules about who can access customer data and how it should be used, or can anyone in the company access any data without restrictions or oversight?",
    options: [
      {
        value: 1,
...
**For example:** When a new employee needs to understand your sales data, can they find clear explanations of what each field means, or do they have to ask around to figure out how the data is organized?",
    options: [
      {
        value: 1,
...
**For example:** Is your data organized in spreadsheets and databases that can be easily analyzed, or is most of your business information stored in emails, paper documents, and unstructured formats?",
    options: [
      {
        value: 1,
...
**For example:** Can your team explain what AI could do for your business and give specific examples, or do most people think AI is just science fiction and have no idea how it might help your company?",
    options: [
      {
        value: 1,
...
**For example:** Has anyone on your team actually used AI tools like ChatGPT for business tasks, built automated reports, or worked with data analysis software to find patterns in your business data?",
    options: [
      {
        value: 1,
...
**For example:** When AI tools are mentioned, does your team get excited about the possibilities and ask lots of questions, or do they worry about job security and prefer to stick with current manual processes?",
    options: [
      {
        value: 1,
...
**For example:** Do you provide courses or workshops where employees can learn about AI and practice using AI tools, or do people have to figure out AI on their own time without company support?",
    options: [
      {
        value: 1,
...
**For example:** Can your team create charts and graphs from business data to spot trends and make decisions, or do they struggle with anything beyond basic spreadsheet calculations?",
    options: [
      {
        value: 1,
...
**For example:** When a customer makes a purchase, does the information automatically update in your inventory, accounting, and customer service systems, or do you have to manually enter the same data in multiple places?",
    options: [
      {
        value: 1,
...
**For example:** If you wanted to add a chatbot to your website that could check order status, could it easily access your order database, or would you need to completely rebuild your systems to make this work?",
    options: [
      {
        value: 1,
...
**For example:** When you've added new software like accounting systems or customer management tools, did the implementation go smoothly and on time, or did it take much longer than expected with lots of problems?",
    options: [
      {
        value: 1,
...
**For example:** If you needed to add a new feature like mobile access to your business data, would this be a simple update, or would you need to rebuild major parts of your technology setup?",
    options: [
      {
        value: 1,
...
**For example:** Can your systems immediately update inventory levels when a sale happens and instantly notify customers about shipping updates, or do these updates only happen once a day when reports are run?",
    options: [
      {
        value: 1,
...
**For example:** Has your company set aside specific money for exploring AI tools and hiring specialists, or are AI projects expected to come out of the general IT budget with no dedicated funding?",
    options: [
      {
        value: 1,
...
**For example:** Would your company pay for employees to attend AI workshops or online courses, or do leaders expect staff to learn about AI on their own time without company support?",
    options: [
      {
        value: 1,
...
**For example:** Could your company afford to hire a data scientist or AI specialist with competitive salary and benefits, or are you limited to using existing employees who would learn AI skills alongside their current jobs?",
    options: [
      {
        value: 1,
...
**For example:** Could your company purchase AI software licenses, cloud computing services, and automation platforms that might cost thousands of dollars monthly, or are you limited to free or very low-cost tools?",
    options: [
      {
        value: 1,
...
**For example:** Does leadership expect AI projects to save money or increase revenue within a few months, or are they willing to wait 1-2 years to see significant returns on AI investments?",
    options: [
      {
        value: 1,
...
**For example:** Do you have firewalls, regular security updates, employee training about phishing emails, and incident response plans, or do you mainly rely on basic antivirus software and hope for the best?",
    options: [
      {
        value: 1,
...
**For example:** Do you have clear rules about who can access customer information, how long you keep personal data, and what you do if there's a data breach, or do you handle customer data without formal privacy policies?",
    options: [
      {
        value: 1,
...
**For example:** Can you quickly provide customers with all the personal data you have about them if they request it, delete their information when asked, and document how you handle their privacy, or would these requests create major challenges?",
    options: [
      {
        value: 1,
...
**For example:** Do employees need special permission and secure passwords to access sensitive business data, and is that data scrambled (encrypted) so it can't be read if stolen, or can anyone in your company access any data with basic passwords?",
    options: [
      {
        value: 1,
...
**For example:** Before using software from other companies or cloud services, do you check their security practices and require them to meet your security standards, or do you simply trust that external vendors are secure without verification?",
    options: [
      {
        value: 1,
