...
import backgroundImage from "@assets/BG3_1756166869568.png";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 bg-white rounded-lg mt-4 sm:mt-6 mb-4 sm:mb-6 shadow-xl border-2 border-[#cd0000] animate-slide-up stagger-delay-1" style={{ boxShadow: '5px 18px 35px -12px rgba(205, 0, 0, 0.08), 0 0 0 1px rgba(205, 0, 0, 0.03)' }}>
